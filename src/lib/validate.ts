...
export const schemas = {
  ...
  settingsUpdate: z.object({
    ...
    theme_primary_text: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
    theme_link: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
    theme_nav_bg: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
    theme_nav_text: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
    theme_hover: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
    theme_media_bg: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
    theme_media_text: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
    theme_success: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
    theme_warning: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
    theme_error: hexColor.or(z.literal("")).nullable().optional().transform((v) => v === "" ? null : v),
