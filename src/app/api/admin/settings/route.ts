...
function serializeSettings(s: Record<string, unknown>): Record<string, unknown> {
  return {
    ...
    theme_primary_text: s.themePrimaryText,
    theme_link: s.themeLink,
    theme_nav_bg: s.themeNavBg,
    theme_nav_text: s.themeNavText,
    theme_hover: s.themeHover,
    theme_media_bg: s.themeMediaBg,
    theme_media_text: s.themeMediaText,
    theme_success: s.themeSuccess,
    theme_warning: s.themeWarning,
    theme_error: s.themeError,
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    const fieldMap: Record<string, string> = {
      ...
      theme_primary_text: "themePrimaryText",
      theme_link: "themeLink",
      theme_nav_bg: "themeNavBg",
      theme_nav_text: "themeNavText",
      theme_hover: "themeHover",
      theme_media_bg: "themeMediaBg",
      theme_media_text: "themeMediaText",
      theme_success: "themeSuccess",
      theme_warning: "themeWarning",
