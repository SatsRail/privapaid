...
Full walkthrough including custom domain, variable reference, and the manual fork path: **[wiki / Deploy on Railway](https://github.com/SatsRail/privapaid/wiki/Deploy-on-Railway)**.
